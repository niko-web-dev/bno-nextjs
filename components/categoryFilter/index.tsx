			...
			<button className={style.filter__close} onClick={closeMenu}>
				<div className={style.filter__closeIcon}>
					<svg width="28" height="28" viewBox="0 0 28 28" fill="none" xmlns="http://www.w3.org/2000/svg">
						<path fillRule="evenodd" clipRule="evenodd" d="M25.1187 1.39811L1.39678 25.1201C0.627801 25.889 0.302179 26.8185 0.671288 27.1876L0.743413 27.2598C1.11252 27.6289 2.04201 27.3033 2.81099 26.5343L26.533 2.81232C27.3019 2.04334 27.629 1.11238 27.2599 0.743267L27.1878 0.671142C26.8187 0.302032 25.8877 0.629128 25.1187 1.39811Z" fill="#231F20"/>
						<path fillRule="evenodd" clipRule="evenodd" d="M26.5328 25.1185L2.81084 1.39654C2.04186 0.627557 1.11237 0.301935 0.743262 0.671044L0.671137 0.743169C0.302028 1.11228 0.62765 2.04177 1.39663 2.81075L25.1186 26.5327C25.8876 27.3017 26.8185 27.6288 27.1876 27.2597L27.2598 27.1875C27.6289 26.8184 27.3018 25.8875 26.5328 25.1185Z" fill="#231F20"/>
					</svg>
				</div>
